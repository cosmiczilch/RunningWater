 ...
 */
class ExampleGame2View extends GLSurfaceView {
    private static String TAG = "ExampleGame2View";
    private static final boolean DEBUG = false;

    public ExampleGame2View(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public ExampleGame2View(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            ExampleGame2Wrapper.InitGameScene();
        }
