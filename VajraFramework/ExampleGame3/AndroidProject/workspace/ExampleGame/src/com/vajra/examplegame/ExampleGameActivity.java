...
public class ExampleGame3Activity extends Activity {

    ExampleGame3View mView;
    public static Context mContext;

    @Override protected void onCreate(Bundle icicle) {
        super.onCreate(icicle);
        mView = new ExampleGame3View(getApplication(), false, 8, 8);
        setContentView(mView);

    	mContext = getApplicationContext();

        VajraAndroidWrapper.SetContext(mContext);
        ExampleGame3Wrapper.SetContext(mContext);
