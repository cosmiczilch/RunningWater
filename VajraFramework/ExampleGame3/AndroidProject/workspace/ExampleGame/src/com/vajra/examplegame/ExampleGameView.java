 ...
 */
class ExampleGame3View extends GLSurfaceView {
    private static String TAG = "ExampleGame3View";
    private static final boolean DEBUG = false;

    public ExampleGame3View(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public ExampleGame3View(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
    	...
    	static {
    		...
    		Renderer.endTime = System.currentTimeMillis();
    		Renderer.dt = 0;
    	}

        public void onDrawFrame(GL10 gl) {
        	Renderer.endTime = System.currentTimeMillis();
        	Renderer.dt = Renderer.endTime - Renderer.startTime;
        	
        	if (dt < Renderer.RENDERER_SLEEP_TIME) {
        		try {
					Thread.sleep((long) (Renderer.RENDERER_SLEEP_TIME - dt));
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            ExampleGame3Wrapper.InitGameScene();
        }
