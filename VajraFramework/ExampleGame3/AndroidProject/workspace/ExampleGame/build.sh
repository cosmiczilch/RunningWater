...
VAJRA_PREBUILT_LIBRARY_DESTINATION_BASE_PATH="./AndroidProject/workspace/ExampleGame3/libs/"
...
then
	...
	then
		echo -e "\nRUNNING...\n"
		adb shell am start -n com.vajra.examplegame/com.vajra.examplegame.ExampleGame3Activity
	fi
fi
